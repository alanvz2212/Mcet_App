...
class SmallEvents1 extends StatefulWidget {
  const SmallEvents1({super.key});

  @override
  State<SmallEvents1> createState() => _CollegeThingsState();
}

class _CollegeThingsState extends State<SmallEvents1> {
