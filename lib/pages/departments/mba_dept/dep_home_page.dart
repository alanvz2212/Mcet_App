                                ...
                                child: Stack(
                                  children: [
                                    Positioned(
                                      ...
                                      left: -6,
                                      child: Image.asset(
                                        'assets/imagesmca_fac/shyma.jpg',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ],
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const DepmbaHomePage(),
                          ),
                        );
                      },
                      child: SizedBox(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      left: -17,
                                      child: Image.asset(
                                        'assets/imagesmca_fac/jogimol.jpg',
                                        fit: BoxFit.fitWidth,
                                      ),
                                    ),
                                  ],
                                ...
                                child: Stack(
                                  children: [
                                    Positioned(
                                      ...
                                      left: -14,
                                      child: Image.asset(
                                        'assets/imagesmca_fac/sindhu.jpg',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ],
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      right: -14,
                                      child: Image.asset(
                                        'assets/imagesmca_fac/rinsa.jpg',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ],
                                ...
                                child: Stack(
                                  children: [
                                    Positioned(
                                      ...
                                      right: -9,
                                      child: Image.asset(
                                        'assets/imagesmca_fac/preethi.jpg',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ],
      ...
      child: ClipRRect(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const DepmbaHomePage()),
            );
          },
